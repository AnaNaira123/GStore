...
public class AppDbSeed
{
    public AppDbSeed(ModelBuilder builder)
    {
        ...
        List<Usuario> usuarios = new() {
            new Usuario(){
                Id = "ddf093a6-6cb5-4ff7-9a64-83da34aee005",
                Email = "anaenaira635@gmail.com",
                NormalizedEmail = "ANAENAIRA635@GMAIL.COM",
                UserName = "AnaNaira",
                NormalizedUserName = "ANANAIRA",
                LockoutEnabled = true,
                EmailConfirmed = true,
                Nome = "Ana Naira Andrade Silva",
                DataNascimento = DateTime.Parse("21/04/2005"),
